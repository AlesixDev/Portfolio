...
export function Projects() {
  ...
  return (
    <section id="projects" ref={ref} className="relative h-[360vh]">
      <div className="sticky top-0 flex h-[var(--card-h,100svh)] flex-col justify-center overflow-hidden">
        ...
        <div ref={track} className="mt-8 w-full overflow-hidden sm:mt-10">
          <motion.div style={{ x }} className="flex w-max gap-5 px-5 sm:gap-8 sm:px-14 lg:px-20">
...
function Screen({ project }: { project: Project }) {
  return (
    <a
      ...
      className="group block w-[80vw] shrink-0 sm:w-[min(38rem,52vw)]"
    >
